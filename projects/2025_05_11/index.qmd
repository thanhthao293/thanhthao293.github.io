---
title: "Analysis of Predictor Contributing to Social Anxiety"
date: 2025-05-11
author: Thao Nguyen
...
as.data.frame(t(metrics),) %>%
  ...
  tab_caption(caption = "Comparison of Different Models across Different Metrics")
```
...
as.data.frame(coef_df) %>%
  ...
  tab_caption("Coefficient Estimates of Logistic Regression")
```
